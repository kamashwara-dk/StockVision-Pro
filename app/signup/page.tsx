...
export default async function SignupPage(props: {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0F1E]">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[var(--accent)] rounded-full mix-blend-screen filter blur-[128px] opacity-10" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#4F46E5] rounded-full mix-blend-screen filter blur-[128px] opacity-10" />
          ...
          {!success && (
            <form method="POST" action="/api/auth/signup" className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <PasswordInput name="confirmPassword" placeholder="Re-enter your password" autoComplete="new-password" />
              </div>
